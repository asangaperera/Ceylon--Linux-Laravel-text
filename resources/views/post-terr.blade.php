...
<form method="post" action="{{route('save.terr')}}"><h2>ADD  TERRITORY </h2><br><br>
@csrf
...
Territory Name:<input type="text" name="t_name" value=""><br>
        <input type="submit" value="Save">  
 </form>
        @if (Route::has('terr'))
    <a href="{{ route('terr') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">View Territory </a>
                        @endif
